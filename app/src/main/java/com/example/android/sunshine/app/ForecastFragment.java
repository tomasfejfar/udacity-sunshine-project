...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_refresh:
                new FetchWeatherTask().execute("46604,cz");
            default:
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.list_item_forecast, R.id.list_item_forecast_view, weekForecast);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String> {
        ...
        public static final String API_KEY = "735283308e7a28a15592c3d878975460";
